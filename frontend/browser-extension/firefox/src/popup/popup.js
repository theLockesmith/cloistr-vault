// Cloistr Vault Browser Extension - Popup Script (Firefox)
...
class CloistrVaultPopup {
  ...
  bindEvents() {
    ...
    if (createAccount) {
      createAccount.addEventListener('click', (e) => {
        e.preventDefault();
        browser.tabs.create({ url: 'https://vault.cloistr.xyz/register' });
      });
    }
    ...
    if (openWebAppLogin) {
      openWebAppLogin.addEventListener('click', (e) => {
        e.preventDefault();
        browser.tabs.create({ url: 'https://vault.cloistr.xyz' });
      });
    }
    ...
    document.getElementById('forgotPassword').addEventListener('click', (e) => {
      e.preventDefault();
      browser.tabs.create({ url: 'https://vault.cloistr.xyz/recovery' });
    });
  ...
  showAddModal() {
    ...
    browser.tabs.create({ url: 'https://vault.cloistr.xyz/vault/add' });
  }

  openSettings() {
    browser.tabs.create({ url: 'https://vault.cloistr.xyz/settings' });
  }
